...
This is a solo project from Scrimba's Node.js course that provides live gold price data in USD. The frontend code (HTML and CSS) was provided by Scrimba. I built the Node.js server and all backend logic from scratch. I integrated the backend data through DOM manipulation and API requests using the Fetch API, route handling, Event Emitters, and Server‑Sent Events.
